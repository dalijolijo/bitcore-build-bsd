...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-bsd/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-bsd -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-bsd -o bitcore-lib-bsd.js';
    }
